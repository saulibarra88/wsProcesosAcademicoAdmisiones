            ...
            <p style='text-align: center;font-size: 10px'> <strong>PERIODO:   ${periodoinfo.data[0].strDescripcion}  </strong> </p><br/>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <th style="font-size: 8px;text-align: center;">CÓDIGO</th>
                  <th style="font-size: 8px;text-align: center;">ASIGNATURA</th>
                  <th style="font-size: 8px;text-align: center;">PAO</th>
                  <th style="font-size: 8px;text-align: center;">MATRICULADOS</th>
              ...
              <br/><br/>
              <p style="text-align: center;"> <strong>----------------------------------------</strong></p>
              <p style="text-align: center;font-size: 10px;"> GENERADO POR:</p>
              <p style="text-align: center;font-size: 10px;">${strNombres}</p>
            </body>
            </html>
            `;
  ...
  try {
    try {
      ...
      listado.forEach(datoslistado => {
        datos += `<br/><div style="font-size: 9px; text-align: left" >ASIGNATURA:  ${datoslistado.strNombre}</div> <div style="font-size: 9px; text-align: left" >CODIGO:  ${datoslistado.strCodMateria}</div>`;
        datos += `
      <table border=2>
        <thead>
          <tr>
    ...
    `;
        var contadot = 0;
        datoslistado.listadoparalelos.forEach(paralelodatos => {
          contadot = contadot + 1;
          datos += `
        <tr>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${contadot}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.strCodNivel}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.strCodParalelo} </td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadtotal}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadprimera}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadsegunda}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadtercera}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.repitencia}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.Aprueban}</td>
  ...
  try {
    ...
    `;
        ...
        <tr>
          ...
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.strCodParalelo} </td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadtotal}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidaddef}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadpen}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadsol}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidadpre}</td>
          <td style="font-size: 8px; text-align: center;font-family: serif;">${paralelodatos.cantidaddefva}</td>
