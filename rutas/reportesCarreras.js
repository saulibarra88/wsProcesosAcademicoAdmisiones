...
module.exports.PdfListadoDocumentosCarreras = async function (listado, cedulaUsuario, periodo) {
  try {
    var resultado = await reportespdfmaker.pdfmakeProcesoPdfListadoDocumentosCarreras(listado, cedulaUsuario, periodo);
    return resultado
  } catch (error) {
    console.error(error);
...
module.exports.PdfListadoEstudianteMatriculasTerceraySegunda = async function (listado, carrera, cedulaUsuario, periodo, tipo) {
  try {
    var resultado = await reportespdfmaker.pdfmakeProcesoPdfTerceraSegundaMatriculaCarrera(listado, carrera, cedulaUsuario, periodo, tipo);
    return resultado
  } catch (error) {
    console.error(error);
...
module.exports.PdfListadoEstudianteMatriculasTerceraySegundaGeneral = async function (listado, carrera, cedulaUsuario, periodo) {
  try {
    var resultado = await reportespdfmaker.pdfmakeProcesoPdfTerceraSegundaMatriculaCarreraGeneral(listado, carrera, cedulaUsuario, periodo);
    return resultado
  } catch (error) {
    console.error(error);
...
module.exports.PdfListadoEstudiantesMatriculasEstadosASignaturas = async function (listado, carrera, cedulaUsuario, periodo) {
  try {
    var resultado = await reportespdfmaker.pdfmakeProcesoPdfMatriculasEstadosNivelParalelo(listado, carrera, cedulaUsuario, periodo);
    return resultado
  } catch (error) {
    console.error(error);
